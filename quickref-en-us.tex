...
Compatibility aliases include \cmd{cwautor}, \cmd{cwassunto}, \cmd{favorcitar}, and \cmd{listofassunto}, together with Portuguese package options. In v1.5.4 the \texttt{rascunho} environment alias is incomplete because only its begin macro is aliased; use \texttt{cwdraft} until issue \#40 is resolved.
